...
## PRIOR ##
path_prior  <- paste( home_dir, "sum_analyses/prior/1/CLK/", sep = "" )
...
prior_half2 <- apply( X = prior_sum$mean[(half_chains+1):num_chains,],
                      MARGIN = 2, FUN = mean )
pdf( paste( outchecks_dir, "ESS_and_chains_convergence/Convergence_plot_prior.pdf", sep = "" ),
     paper = "a4" )
...
# pdf( paste( outchecks_dir, "ESS_and_chains_convergence/Convergence_plot_prior_filt.pdf", sep = "" ),
#      paper = "a4" )
